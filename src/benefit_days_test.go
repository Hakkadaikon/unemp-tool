...
func TestBenefitDays_Calc(t *testing.T) {
	tests := []struct {
		...
		// {"会社都合退職, 29歳, 被保険者期間: 1年", 29, 1, 1, 90},
		// {"会社都合退職, 29歳, 被保険者期間: 4年", 29, 4, 1, 90},
		// {"会社都合退職, 29歳, 被保険者期間: 5年", 29, 5, 1, 90},
		// {"会社都合退職, 29歳, 被保険者期間: 9年", 29, 9, 1, 90},
		// {"会社都合退職, 29歳, 被保険者期間: 10年", 29, 10, 1, 90},
		// {"会社都合退職, 29歳, 被保険者期間: 19年", 29, 19, 1, 0},
		// {"会社都合退職, 29歳, 被保険者期間: 20年", 29, 20, 1, 0},

		// {"会社都合退職, 25歳, 被保険者期間: 3年", 29, 3, 1, 90},
		// {"会社都合退職, 35歳, 被保険者期間: 7年", 35, 7, 1, 180},
		// {"会社都合退職, 50歳, 被保険者期間: 12年", 50, 12, 1, 270},
		// {"会社都合退職, 45歳, 被保険者期間: 20年", 45, 20, 1, 330},

		// // 自己都合の退職の場合
		// {"自己都合退職, 25歳, 被保険者期間: 3年", 25, 3, 4, 90},
		// {"自己都合退職, 35歳, 被保険者期間: 7年", 35, 7, 4, 90},
		// {"自己都合退職, 45歳, 被保険者期間: 12年", 45, 12, 4, 120},
		// {"自己都合退職, 50歳, 被保険者期間: 20年", 50, 20, 4, 150},
